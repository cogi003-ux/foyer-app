...
st.markdown("""
    ...
    .desc-text { font-size: 0.85em; color: #666; margin-top: 4px; display: block; }
    </style>
...
# 4. MISSIONS
    ...
    tasks = [
        {"n": "🍳 Chef Étoilé", "p": 20, "c": "Cuisine", "r": ["Parent"], "d": "Préparer un bon repas pour la famille."},
        {"n": "🍽️ Maître du Couvert", "p": 10, "c": "Cuisine", "r": ["Enfant"], "d": "Mettre la table proprement."},
        {"n": "🧼 Ranger l'assiette", "p": 10, "c": "Cuisine", "r": ["Enfant"], "d": "Débarrasser la table après manger."},
        {"n": "🍽️ Plongeur d'élite", "p": 15, "c": "Cuisine", "r": ["Parent", "Ado"], "d": "Faire la vaisselle ou vider le lave-vaisselle."},
        {"n": "⚡ Micro-Onde Brillant", "p": 15, "c": "Cuisine", "r": ["Parent"], "d": "Laver l'intérieur du micro-onde."},
        {"n": "🧊 Frigo comme Neuf", "p": 20, "c": "Cuisine", "r": ["Parent"], "d": "Nettoyer l'intérieur du frigo."},
        {"n": "🔥 Mission Pyrolyse", "p": 50, "c": "Cuisine", "r": ["Parent"], "d": "Laver le four à fond."},
        {"n": "🌀 Tornade Aspirateur", "p": 15, "c": "Ménage", "r": ["Parent", "Ado"], "d": "Passer l'aspirateur sur tout le bas."},
        {"n": "✨ Miroir d'Eau", "p": 20, "c": "Ménage", "r": ["Parent", "Ado"], "d": "Passer la serpillière en bas."},
        {"n": "🌬️ Chasse à la Poussière", "p": 10, "c": "Ménage", "r": ["Parent"], "d": "Prendre les poussières en bas."},
        {"n": "🏰 Grand Nettoyage", "p": 40, "c": "Ménage", "r": ["Parent"], "d": "Haut : Aspi+Serpi+Poussière+SdB."},
        {"n": "🧸 Magicien du Salon", "p": 15, "c": "Ménage", "r": ["Enfant"], "d": "Ramasser tous les jouets éparpillés."},
        {"n": "🚀 Mission Décollage", "p": 10, "c": "Ménage", "r": ["Enfant"], "d": "Faire son lit et ranger son pyjama."},
        {"n": "🏰 Gardien de la Chambre", "p": 25, "c": "Ménage", "r": ["Enfant"], "d": "Ranger sa chambre à fond."},
        {"n": "🧺 Expert du Linge", "p": 15, "c": "Ménage", "r": ["Parent", "Ado"], "d": "Plier une panière de linge propre."},
        {"n": "👟 Gardien du Hall", "p": 5, "c": "Ménage", "r": ["Parent", "Ado", "Enfant"], "d": "Aligner les chaussures dans l'entrée."},
        {"n": "🦷 Sourire de Star", "p": 5, "c": "Hygiène", "r": ["Enfant"], "d": "Brossage de dents complet sans rouspéter."},
        {"n": "🚿 Éclat Sanitaire", "p": 30, "c": "Hygiène", "r": ["Parent"], "d": "Laver les WC (lunette et cuvette)."},
        {"n": "🗑️ Alerte Déchets", "p": 20, "c": "Déchets", "r": ["Parent", "Ado"], "d": "Sortir les poubelles à rue (Lundi/Mercredi)."},
        {"n": "📦 Lutin du Recyclage", "p": 10, "c": "Déchets", "r": ["Parent", "Ado", "Enfant"], "d": "Vider les poubelles intérieures dans la grande."},
        {"n": "🚜 Maître de la Jungle", "p": 40, "c": "Extérieur", "r": ["Parent", "Ado"]},
        {"n": "🏎️ Car Wash Privé", "p": 40, "c": "Extérieur", "r": ["Parent", "Ado"], "d": "Laver l'extérieur de la voiture."},
        {"n": "💎 Vue Cristalline", "p": 50, "c": "Extérieur", "r": ["Parent"], "d": "Laver toutes les fenêtres de la maison."}
    ]
    ...
    for cat in ["Cuisine", "Ménage", "Hygiène", "Déchets", "Extérieur"]:
        ...
        if cat_t:
            ...
            for t in cat_t:
                ...
                with col_i: 
                    # Affichage avec l'explication (desc-text)
                    st.markdown(f"""
                        <div class='mission-card'>
                            <span class='pts-badge'>+{t['p']} pts</span>
                            <b>{t['n']}</b><br>
                            <span class='desc-text'>📝 {t.get('d', 'Tâche standard')}</span>
                ...
                with col_b:
                    ...
                    if t['n'] in pending: st.button("⌛ Attente", key=f"p_{t['n']}", disabled=True)
                        ...
                        if st.button(label, key=f"f_{t['n']}"):
                            if is_parent:
